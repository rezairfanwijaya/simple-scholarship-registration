const Card = (props) => {
    return (<>
        ...
        <div className="card bg-white p-4 rounded-md flex flex-col gap-5 md:w-1/2 md:justify-end lg:justify-between hover:shadow-md">
            ...
            <div className="body flex justify-between items-center lg:px-10">
                <div className="title text-sm text-dark w-1/2 md:w-2/3 lg:text-lg">{props.title}</div>
                <button
                    data-modal-target={props.idModal} data-modal-toggle={props.idModal}
                    className="text-xs bg-secondary p-3 rounded-md md:p-2 lg:text-md lg:px-5 lg:py-3"
                >
                    Lihat Detail
                </button>
            </div>
            ...
            <div className="relative w-full h-full max-w-2xl md:h-auto">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide={props.idModal}>
